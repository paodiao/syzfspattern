...
func (mgr *Manager) runInstanceInner(index int, instanceName string) (*report.Report, []byte, error) {
	...
	args := &instance.FuzzerCmdArgs{
		...
		FSName:      mgr.cfg.FSName,
		FSImageNum:  mgr.cfg.FSImageNum,
		FSMntCmdNum: mgr.cfg.FSMntCmdNum,
		FSMntCmdCur: mgr.cfg.FSMntCmdCur,
	}
	mgr.cfg.FSMntCmdCur = (mgr.cfg.FSMntCmdCur + 1) % (mgr.cfg.FSImageNum * mgr.cfg.FSMntCmdNum)
