...
type Config struct {
	...
	FSImageNum  int    `json:"fs_image_num"`
	FSMntCmdNum int    `json:"fs_mnt_cmd_num"`
	FSMntCmdCur int    `json:"fs_mnt_cmd_cur"`
	// QEMU image device.
...
func ctor(env *vmimpl.Env) (vmimpl.Pool, error) {
	...
	cfg := &Config{
		...
		Snapshot:    true,
		FSName:      env.FSName,
		FSImageNum:  env.FSImageNum,
		FSMntCmdNum: env.FSMntCmdNum,
		FSMntCmdCur: env.FSMntCmdCur,
	}
