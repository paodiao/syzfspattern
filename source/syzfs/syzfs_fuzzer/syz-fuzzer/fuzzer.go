...
func main() {
	...
	var (
		...
		fsImageNum   = flag.Int("FSImageNum", 0, "number of FS images")
		fsMntCmdNum  = flag.Int("FSMntCmdNum", 0, "number of FS mount commands")
		fsMntCmdCur  = flag.Int("FSMntCmdCur", 0, "number of current FS mount command")
		fsName       = flag.String("FSName", "", "file system name")
	)
	defer tool.Init()()
	...
	config.FSName = *fsName
	config.FSImageNum = *fsImageNum
	config.FSMntCmdNum = *fsMntCmdNum
	config.FSMntCmdCur = *fsMntCmdCur
